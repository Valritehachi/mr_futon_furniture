...
//               className="w-50 px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white"
//             />
//             {newHeroImage && (
//               <div className="mt-3">
//                 <img
...
//                   alt="Preview"
//                   className="w-50 h-48 object-cover rounded-lg border-2 border-gray-200"
//                 />
//               </div>
//             )}
//           </div>
...
//               const base64 = await fileToBase64(newHeroImage);

//               // Add it to hero images
//               const updatedImages = [...heroImages, base64];
